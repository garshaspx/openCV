...
def video():
    ...
    cam_chooser = ttk.Combobox(vid_win, width = 20, textvariable = StringVar())
    print(type(cam_chooser))
    if arr != []:
...
Button(win, text="close", command= lambda : exit("Error message"), fg="red").place(x=10, y=225)
